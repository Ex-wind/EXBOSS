...
local function RefreshList()
    ...
    for _, item in ipairs(ITEMS) do
        ...
        if matched then
            ...
            if ExBoss.UI and ExBoss.UI.ApplySidebarModuleButtonState and button.label then
                ...
                button.fs:SetTextColor(unpack(active and COLOR.Accent.Primary or COLOR.Text.Primary))
            end
    ...
    if shown == 0 then
        ...
        if ExBoss.UI and ExBoss.UI.ApplySidebarModuleButtonState and empty.label then
            ...
            empty.fs:SetTextColor(unpack(COLOR.Text.Disabled))
        end
...
function Page:Render(leftFrame, contentFrame)
    ...
    if not resetButton then
        ...
        resetButton:GetFontString():SetTextColor(unpack(COLOR.Text.Danger))
